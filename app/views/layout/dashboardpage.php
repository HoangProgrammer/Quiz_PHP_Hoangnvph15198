...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">PHP-2</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="<?=URL?>login">Đăng xuất</a>
    </div>
  </div>
</header>
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item li_dash">
            <a class="nav-link text-light" href="<?=URL?>mon-hoc">
            <i  style="font-size:24px" class="far fa-file"></i>
              Môn học
            </a>
          </li>
          <li class="nav-item li_dash">
            <a class="nav-link text-light" href="<?=URL?>hoc-vien">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      ...
      <!-- <h2>Section title</h2> -->
 <?php require_once('./app/views/admin/'.$data['pages'].'.php') ?>
    </main>
