...
<head>
  ...
  <title> @yield('title', 'WE16302 - PHP2')</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&amp;display=fallback">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Tempusdominus Bootstrap 4 -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}plugins/jqvmap/jqvmap.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}dist/css/adminlte.min.css">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}plugins/daterangepicker/daterangepicker.css">
  <!-- summernote -->
  <link rel="stylesheet" href="{{URL_PUBLIC}}plugins/summernote/summernote-bs4.min.css">
  <style type="text/css">
    /* Chart.js */
...
<body class="sidebar-mini" style="height: auto;" cz-shortcut-listen="true">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">Hoàng ng</a>
          </div>
        </div>
 ...
 with font-awesome or any other icon font library -->
            ...
            <li class="nav-item">
              <a href="{{URL}}mon-hoc" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{URL}}hoc-vien" class="nav-link">
    ...
    <aside class="control-sidebar control-sidebar-dark" style="display: none;">
      ...
      <div class="p-3 control-sidebar-content" style="">
        ...
        <div class="d-flex"></div><select class="custom-select mb-3 border-0">
          ...
          <option class="bg-warning">Warning</option>
          <option class="bg-white">White</option>
          <option class="bg-orange">Orange</option>clear
        </select>
      </div>
      <div class="p-3 control-sidebar-content" style="">
        <h5>Customize AdminLTE</h5>
